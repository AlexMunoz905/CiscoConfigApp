...
if ConfIP == "yes":
    outIP = input("What should the outside IP be?: ").lower()

if EnPass == "yes":
    enablePass = input("What should the enable password be?: ").lower()

if ConPass == "yes":
    ConsolePass = input("What should the console password be?: ").lower()

if SshPass == "yes":
    TelnetPass = input("What should the Telnet / SSH password be?: ").lower()